...
class TurnBased {
     ...
     */
    async totalGames(signer) {
        return api_1.TurnBasedAPI.totalGames(this.node.url, this.networkMagic, this.scriptHash, signer);
    }
    async getGameJSON(gameId, signer) {
        return api_1.TurnBasedAPI.getGameJSON(this.node.url, this.networkMagic, this.scriptHash, gameId, signer);
    }
    async joinGame(tokenId, signer) {
        return api_1.TurnBasedAPI.joinGame(this.node.url, this.networkMagic, this.scriptHash, tokenId, signer);
    }
    async fight(gameId, tokenId, attribute, signer) {
        return api_1.TurnBasedAPI.fight(this.node.url, this.networkMagic, this.scriptHash, gameId, tokenId, attribute, signer);
    }
}
