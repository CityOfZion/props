...
export declare class TurnBased {
     ...
     */
    totalGames(signer?: wallet.Account): Promise<number>;
    getGameJSON(gameId: string, signer: wallet.Account): Promise<any>;
    joinGame(tokenId: string, signer: wallet.Account): Promise<string>;
    fight(gameId: string, tokenId: string, attribute: string, signer: wallet.Account): Promise<number | string>;
}
