...
import fs from 'fs'
import { buildUpdateInvocation } from '.'


export function buildCreateCollectionInvocation(scriptHash: string, params: {description: string, collectionType: string, extra: string, values: (string|number)[]}): ContractInvocation{
  return {
    scriptHash,
...
export function buildGetCollectionJSONInvocation(scriptHash: string, params: {collectionId: number}): ContractInvocation{
  return {
    scriptHash,
...
export function buildGetCollectionInvocation(scriptHash: string, params: {collectionId: number}): ContractInvocation{
  return {
    scriptHash,
...
export function buildGetCollectionElementInvocation(scriptHash: string, params: {collectionId: number, index: number}): ContractInvocation{
  return {
    scriptHash,
...
export function buildGetCollectionLengthInvocation(scriptHash: string, params: {collectionId: number}): ContractInvocation{
  return {
    scriptHash,
...
export function buildGetCollectionValuesInvocation(scriptHash: string, params: {collectionId: number}): ContractInvocation{
  return {
    scriptHash,
...
export function buildMapBytesOntoCollectionInvocation(scriptHash: string, params: {collectionId: number, entropy: string}): ContractInvocation{
  return {
    scriptHash,
...
export function buildSampleFromCollectionInvocation(scriptHash: string, params: {collectionId: number, samples: number}): ContractInvocation{
  return {
    scriptHash,
...
export function buildSampleFromRuntimeCollectionInvocation(scriptHash: string, params: {values: string[], samples: number, pick: boolean}): ContractInvocation{
  return {
    scriptHash,
...
export function buildTotalCollectionsInvocation(scriptHash: string): ContractInvocation{
  return {
    scriptHash,
