...
export declare class PackageAPI {
    ...
    static createEpoch(node: string, networkMagic: number, contractHash: string, label: string, generatorInstanceId: number, chestId: number, mintFee: number, sysFee: number, maxSupply: number, signer: wallet.Account): Promise<string>;
    /**
