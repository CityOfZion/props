...
CONTRACT_DIR = GHOST_ROOT + '/NEP11/'
CONTRACT_PATH_PY = GHOST_ROOT + '/NEP11/GhostMarket.NFT.py'
CONTRACT_PATH_JSON = GHOST_ROOT + '/NEP11/GhostMarket.NFT.manifest.json'
CONTRACT_PATH_NEFDBG = GHOST_ROOT + '/NEP11/GhostMarket.NFT.nefdbgnfo'
CONTRACT_PATH_NEF = GHOST_ROOT + '/NEP11/GhostMarket.NFT.nef'
 
CONTRACT_PATH_PY_CLEANED = GHOST_ROOT + '/NEP11/GhostMarket.NFT_cleaned.py'
