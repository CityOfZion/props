...
export declare class Puppet {
    ...
    createEpoch(label: string, generatorId: number, initialRollCollectionId: number, mintFee: number, sysFee: number, maxSupply: number, signer: wallet.Account): Promise<string>;
