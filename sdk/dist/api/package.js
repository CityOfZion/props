...
class PackageAPI {
    ...
    static async createEpoch(node, networkMagic, contractHash, label, generatorInstanceId, chestId, mintFee, sysFee, maxSupply, signer) {
    ...
    static async getTokenJSON(node, networkMagic, contractHash, tokenId, signer) {
    ...
    static async getTokenJSONFlat(node, networkMagic, contractHash, tokenId, signer) {
    ...
    static async getTokenRaw(node, networkMagic, contractHash, tokenId, signer) {
        const method = "get_token_raw";
        const params = [neon_js_1.sc.ContractParam.string(tokenId)];
        const res = await (0, helpers_1.variableInvoke)(node, networkMagic, contractHash, method, params, signer);
        if (signer) {
            return res;
