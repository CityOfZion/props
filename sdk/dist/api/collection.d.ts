...
export declare class CollectionAPI {
    ...
    static sampleFromRuntimeCollection(node: string, networkMagic: number, contractHash: string, values: string[], samples: number, pick: boolean, signer: wallet.Account): Promise<string>;
