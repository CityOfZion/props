...
export class Puppet {
  ...
  async balanceOf(options: {address: string}): Promise<number> {
		return await this.singleInvocationTestInvoke({...options}, Puppet.buildBalanceOfInvocation)
  }
  ...
  async createEpoch(options:{label: string, generatorInstanceId: number, initialRollCollectionId: number, mintFee: number, sysFee: number, maxSupply: number}): Promise<string> {
    return await this.config.invoker.invokeFunction({
      invocations: [
        Puppet.buildCreateEpochInvocation(this.config.scriptHash, {...options})
      ],
      signers: [],
    })
  }
  ...
  async decimals(): Promise<number> {
    return await this.singleInvocationTestInvoke({}, Puppet.buildDecimalsInvocation)
  }

  async deploy(): Promise<string> {
    return await this.config.invoker.invokeFunction({
      invocations: [
        Puppet.buildDeployInvocation(this.config.scriptHash)
      ],
      signers: [],
    })
  }
  ...
  async getAttributeMod(options: {attributeValue: number}): Promise<number | string> {
    const res = await this.config.invoker.testInvoke({
			invocations: [
        Puppet.buildGetAttributeModInvocation(this.config.scriptHash, {...options})
			],
			signers: [],
		})
  ...
  async getEpochJSON(options: {epochId: number}): Promise<EpochType> {
    return await this.singleInvocationTestInvoke({...options}, Puppet.buildGetEpochJSONInvocation)
  }

  async getPuppetJSON(options: {tokenId: string}): Promise<PuppetType> {
    return await this.singleInvocationTestInvoke({...options}, Puppet.buildGetPuppetJSONInvocation)
  }

  async getPuppetRaw(options: {tokenId: string}): Promise<string> {
    return await this.singleInvocationTestInvoke(options, Puppet.buildGetPuppetRawInvocation)
  }

  async ownerOf(options: {tokenId: string}): Promise<string> {
    return await this.singleInvocationTestInvoke(options, Puppet.buildOwnerOfInvocation)
  }

  async offlineMint(options: {epochId: number, owner: string}): Promise<string> {
    return await this.config.invoker.invokeFunction({
      invocations: [
        Puppet.buildOfflineMintInvocation(this.config.scriptHash, {...options})
      ],
      signers: [],
    })
  }
  ...
  async properties(options: {tokenId: string}): Promise<PuppetType | string> {
    return await this.singleInvocationTestInvoke(options, Puppet.buildPropertiesInvocation)
  }
  ...
  async symbol(): Promise<string> {
    return await this.singleInvocationTestInvoke({}, Puppet.buildSymbolInvocation)
  }

  async tokens(): Promise<number[]> {
    return await this.singleInvocationTestInvoke({}, Puppet.buildTokensInvocation)
  }

  async tokensOf(options: {address: string}): Promise<string[]> {
    return await this.singleInvocationTestInvoke(options, Puppet.buildTokensOfInvocation)
  }

  async totalAccounts(): Promise<number> {
    return await this.singleInvocationTestInvoke({}, Puppet.buildTotalAccountsInvocation)
  }

  async totalEpochs(): Promise<number> {
    return await this.singleInvocationTestInvoke({}, Puppet.buildTotalEpochsInvocation)
  }

  async totalSupply(): Promise<number> {
    return await this.singleInvocationTestInvoke({}, Puppet.buildTotalSupplyInvocation)
  }
  ...
  static buildBalanceOfInvocation(scriptHash: string, params: {address: string}): ContractInvocation{
    return {
      scriptHash,
      operation: 'balanceOf',
      args: [
  ...
  static buildCreateEpochInvocation(scriptHash: string, params: {label: string, generatorInstanceId: number, initialRollCollectionId: number, mintFee: number, sysFee: number, maxSupply: number}): ContractInvocation{
    return {
      scriptHash,
  ...
  static buildGetAttributeModInvocation(scriptHash: string, params: {attributeValue: number}): ContractInvocation{
    return {
      scriptHash,
  ...
  static buildGetEpochJSONInvocation(scriptHash: string, params: {epochId: number}): ContractInvocation{
    return {
      scriptHash,
  ...
  // FLAT?
  static buildGetPuppetJSONInvocation(scriptHash: string, params: {tokenId: string}): ContractInvocation{
    return {
      scriptHash,
  ...
  static buildGetPuppetRawInvocation(scriptHash: string, params: {tokenId: string}): ContractInvocation{
    return {
      scriptHash,
  ...
  static buildOwnerOfInvocation(scriptHash: string, params: {tokenId: string}): ContractInvocation{
    return {
      scriptHash,
      operation: 'ownerOf',
      args: [
  ...
  static buildOfflineMintInvocation(scriptHash: string, params: {epochId: number, owner: string}): ContractInvocation{
    return {
      scriptHash,
  ...
  static buildPropertiesInvocation(scriptHash: string, params: {tokenId: string}): ContractInvocation{
    return {
      scriptHash,
  ...
  static buildSetMintFeeInvocation(scriptHash: string, params: {epochId: number, fee: number}): ContractInvocation{
    return {
      scriptHash,
  ...
  static buildTokensOfInvocation(scriptHash: string, params: {address: string}): ContractInvocation{
    return {
      scriptHash,
      operation: 'tokensOf',
      args: [
  ...
  static buildTransferInvocation(scriptHash: string, params: {to: string, tokenId: string, data: any}): ContractInvocation{
    return {
      scriptHash,
      operation: 'transfer',
      args: [
