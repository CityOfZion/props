...
export declare class GeneratorAPI {
    static createGenerator(node: string, networkMagic: number, contractHash: string, label: string, signer: wallet.Account): Promise<string>;
    ...
    static mintFromGenerator(node: string, networkMagic: number, contractHash: string, generatorId: number, signer: wallet.Account): Promise<string>;
